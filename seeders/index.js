...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'k2zwEDPfI3z3qf5',
      'isDeleted':false,
      'username':'Judson99',
      'email':'Jake_Shanahan77@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Judson99' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'rghcUJwnkOH790r',
      'isDeleted':false,
      'username':'Retta_Dach33',
      'email':'Tristian96@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Retta_Dach33' }, userToBeInserted,  { upsert: true });
